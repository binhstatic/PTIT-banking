...
public class Home extends javax.swing.JFrame {
    ...
    private void btn_KhachHangMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_KhachHangMousePressed
        ...
        resetColor(new JPanel[]{btn_ChuyenTien, btn_Home, btn_TaiKhoan, btn_GiaoDich, btn_NhanVien}, new JPanel[]{ind_5, ind_1, ind_3, ind_4, ind_6});
        employee.setVisible(false);
    ...
    private void btn_TaiKhoanMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_TaiKhoanMousePressed
        ...
        resetColor(new JPanel[]{btn_ChuyenTien, btn_KhachHang, btn_Home, btn_GiaoDich, btn_NhanVien}, new JPanel[]{ind_5, ind_2, ind_1, ind_4, ind_6});
    ...
    private void btn_ChuyenTienMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_ChuyenTienMouseReleased
        // TODO add your handling code here:
        setColor(btn_ChuyenTien);
        ind_5.setOpaque(true);
        resetColor(new JPanel[]{btn_Home, btn_KhachHang, btn_TaiKhoan}, new JPanel[]{ind_1, ind_2, ind_3});
